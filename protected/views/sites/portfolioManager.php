            ...
            <ul class="nav nav-pills nav-stacked" id="side-menu">
                ...
                if ($websites->sel_knowledge == 'true')
                    ...
                    if ($websites->sel_published == 'true') {
                        echo '<li>
                            <a href="index.php?r=Sites/Published&id=' . $website_id . '"><i class="fa fa-newspaper-o fa-fw"></i> ข่าวประชาสัมพันธ์ศิษย์เก่า</a>
                        </li>';
                    }
                 ...
                 if ($userid != null) {
                    if ($is_admin == 1) {
                        echo '<ol class="breadcrumb">
                                <li><a href="index.php?r=Sites/PortfolioCreate&id='.$website_id.'">เพิ่มใหม่</a></li>
                    ...
                    <table class="table table-striped table-bordered table-hover table-list-search" id="dataTables-example">
                        ...
                        foreach ($model as $model):
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" >
                                        <a href="index.php?r=Sites/PortfolioDetail&id=<?php echo $id; ?>" class="btn btn-primary view-site" data-title="ดูรายละเอียด" rel="tooltip">
                                            <i class="glyphicon glyphicon-eye-open"></i>
                                        </a>
                                        <a class="btn btn-warning view-site"data-title="แก้ไข" rel="tooltip"
                                           href="index.php?r=Sites/PortfolioEdit&id=<?php echo $id; ?>">
