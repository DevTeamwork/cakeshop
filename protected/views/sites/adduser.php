    ...
    <div class="col-sm-9">     
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li><a href="index.php?r=Sites/Users&id=<?php echo $website_id; ?>">ทำเนียบศิษย์เก่า</a></li>
                        <li class="active">เพิ่มสมาชิกใหม่</a></li>
                    </ol> 
                    <div class="well well-sm">        
                        <?php
                        $this->renderPartial('partialFormRegister',
