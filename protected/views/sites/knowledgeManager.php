                 ...
                 if ($userid != null) {
                    if ($is_admin == TRUE) {
                        echo '<ol class="breadcrumb">
                                ...
                                <li><a href="index.php?r=Sites/KhowledgeCreate&id='.$website_id.'">เพิ่ม</a></li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-xs" >
                                        <a href="index.php?r=Sites/KnowledgeDetail&id=<?php echo $id; ?>" class="btn btn-primary view-site" data-title="ดูรายละเอียด" rel="tooltip">
                                            <i class="glyphicon glyphicon-eye-open"></i>
                                        </a>
                                        <a class="btn btn-warning view-site"data-title="แก้ไข" rel="tooltip"
                                           href="index.php?r=Sites/KhowledgeEdit&id=<?php echo $id; ?>">
