...
//                alert($("#form").serialize());
                portfolioSave($("#form").serialize());
//                location.href = "index.php?r=Sites/Portfolios&id="+$("#website_id").val();
...
//                    echo '<li><a href="index.php?r=Sites/Knowledges&id=' . $website_id . '"><i class="fa fa-book fa-fw"></i> สาระน่ารู้</a></li>';
    ...
    <div class="col-sm-9">     
        <div class="row">
            ...
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><a href="index.php?r=Sites/Portfolios&id=<?php echo $websites->website_id ?>"><i class="fa fa-briefcase fa-fw"></i> ผลงานศิษย์เก่า</a></li> 
                    <li><a href="index.php?r=Sites/PortfolioManager&id=<?php echo $websites->website_id ?>">จัดการ</a></li> 
                    <li><a href="index.php?r=Sites/PortfolioCreate&id=<?php echo $websites->website_id ?>">สร้าง</a></li>
                    <li><a href="index.php?r=Sites/PortfolioDetail&id=<?php echo $model->id; ?>" target="_blank">ฟรีวิว</a></li>
