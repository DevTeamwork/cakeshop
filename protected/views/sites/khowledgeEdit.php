...
<div class="container container-jp">
    ...
    <div class="col-sm-9">     
        <div class="row">
            ...
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><a href="index.php?r=Sites/Knowledges&id=<?php echo $websites->website_id ?>"><i class="fa fa-book fa-fw"></i> สาระน่ารู้</a></li> 
                    <li><a href="index.php?r=Sites/KhowledgeManager&id=<?php echo $websites->website_id ?>">จัดการ</a></li> 
                    <li><a href="index.php?r=Sites/KhowledgeCreate&id=<?php echo $websites->website_id ?>">สร้าง</a></li>
                    <li><a href="index.php?r=Sites/KhowledgeDetail&id=<?php echo $model->id; ?>" target="_blank">ฟรีวิว</a></li>
