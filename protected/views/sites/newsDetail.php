    ...
    <div class="col-sm-9">     
        <div class="row">
            ...
            <div class="col-lg-12">  
                ...
                <p></p>
                <ol class="breadcrumb">
                    <li><a href="index.php?r=Sites/NewsAll&id=<?php echo $websites->website_id; ?>">ข่าวทั้งหมด</a></li>
                    <li><a href="index.php?r=Sites/News&id=<?php echo $websites->website_id; ?>">ข่าววันนี้</a></li>
                ...
                <nav>
                    <ul class="pager">
                        <li class="previous"><a href="index.php?r=Sites/News&id=<?php echo $websites->website_id; ?>">&larr; กลับ</a></li>
