                    ...
                    if ($websites->sel_register == 'true') {
                        if ($userid != null) {
                            if ($is_admin != 1) {
                                ...
                                echo '<li class="active"><a href="index.php?r=Sites/UserProfileEdit&id=' . $userid . '"><i class="fa fa-edit fa-fw"></i> แก้ไขข้อมูลส่วนตัว</a></li>';
                            }
                        } else {
                            if ($is_admin != 1) {
...
//                    echo '<li><a href="index.php?r=Sites/Knowledges&id=' . $website_id . '"><i class="fa fa-book fa-fw"></i> สาระน่ารู้</a></li>';
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-edit fa-fw"></i> แก้ไขข้อมูลส่วนตัว : <?php echo $model->username; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="well">
                <?php
                $this->renderPartial('partialUserEdit', array("model" => $model, 'userid' => $userid, 'page' => 'index'));
                ?>
            </div>
        </div>
    </div>
