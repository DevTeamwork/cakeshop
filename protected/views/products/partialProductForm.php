...
<form id="userinfo-form" class="form-horizontal" role="form">
    ...
    <input type="hidden" id="product_id" name="product_id" value="<?php echo $userid; ?>" />
    ...
    <fieldset>
        <legend><i class="fa fa-user fa-fw"></i> ข้อมูลสินค้า</legend>
        <p><span class="required">หมายเหตุ ถ้ามีเครื่องหมาย (*) :  กรุณากรอกให้ครบ </span></p>
        <div class="form-group">
            <label for="firstname" class="col-md-2 control-label">ชื่อสินค้า<span class="required">*</span></label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="name" placeholder="ตัวอย่าง : เค้กวนิลา" 
                       value="<?php echo $name; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <textarea type="text" class="form-control" name="discription" id="discription" placeholder="ตัวอย่าง : ได้ฤกษ์ประเดิมเครื่องใหม่ซักทีค่ะ หลังจากซื้อมาได้ 2 เดือนแล้ว นั้นคือ Kitchenaid  สีชมพู สุดสวยค่ะ ปลื้ม ^ ^ เก็บเงินตั้งนานกว่าจะได้มา เครื่องนี้ฝากพี่โบว์ Vishuda ซื้อให้ค่ะ ขอบพระคุณมากเลยนะคะ"
                          ><?php echo $address_contact; ?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="nickname" class="col-md-2 control-label">จำนวน</label>
            <div class="col-md-9">
