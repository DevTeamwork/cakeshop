 ...
 *
 * The followings are the available columns in table 'publisheds':
 * @property integer $id
 ...
 */
class Publisheds extends CActiveRecord
{
	/**
...
//		return array(
//			array('title, detail, postdated, posttime, website_id', 'required'),
//			array('website_id', 'numerical', 'integerOnly'=>true),
//			array('title', 'length', 'max'=>255),
//			// The following rule is used by search().
//			// @todo Please remove those attributes that should not be searched.
//			array('id, title, detail, postdated, posttime, website_id', 'safe', 'on'=>'search'),
//		);
//	}
...
//	}
	 ...
	 * @return Publisheds the static model class
	 */
