...
//		return array(
//			array('quesion_id, postdate, posttime, detail, userid, website_id', 'required'),
//			array('quesion_id, userid, website_id', 'numerical', 'integerOnly'=>true),
//			// The following rule is used by search().
//			// @todo Please remove those attributes that should not be searched.
//			array('id, quesion_id, postdate, posttime, detail, userid, website_id', 'safe', 'on'=>'search'),
//		);
//	}
...
//		$criteria->compare('quesion_id',$this->quesion_id);
